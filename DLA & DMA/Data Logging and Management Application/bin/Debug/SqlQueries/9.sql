-- ADDING A PROCEDURE
CREATE PROCEDURE InsertIntoTable6Columns
...
@ColumnName5 char(30),  @Value5 char(30), @ColumnName6 char(30),  @Value6 char(30) AS 
...
', ' + QUOTENAME(@ColumnName5) + ', ' + QUOTENAME(@ColumnName6) + ') VALUES (''' + @Value1 + ''', ''' + @Value2 + ''', ''' + @Value3 + ''', ''' + @Value4 + ''', ''' 
+ @Value5 + ''', ''' + @Value6 + ''')';
