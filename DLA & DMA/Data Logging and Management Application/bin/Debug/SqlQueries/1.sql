...
INSERT LED (LED_ID, Description, State, Color, ChanIdentifier) VALUES (0, 'Indicates if the plantlight is turned on.', 0, 'Green', 'Dev1/port0/line1')
INSERT LED (LED_ID, Description, State, Color, ChanIdentifier) VALUES (1, 'Indicates if the AC cooling is turned on.', 0, 'Yellow', 'Dev1/port0/line2')
INSERT LED (LED_ID, Description, State, Color, ChanIdentifier) VALUES (2, 'Indicates if the AC heating is turned on.', 0, 'Red', 'Dev1/port0/line3')
