...
INSERT LED (LED_ID, Description, State, Color, ChanIdentifier) VALUES (0, 'Indicates that datalogging is ongoing.', 0, 'Green', 'Dev1/port0/line0')
INSERT LED (LED_ID, Description, State, Color, ChanIdentifier) VALUES (1, 'Indicates that the plantlight is turned on.', 0, 'Green', 'Dev1/port0/line1')
INSERT LED (LED_ID, Description, State, Color, ChanIdentifier) VALUES (2, 'Indicates that the AC cooling is turned on.', 0, 'Yellow', 'Dev1/port0/line2')
INSERT LED (LED_ID, Description, State, Color, ChanIdentifier) VALUES (3, 'Indicates that the AC heating is turned on.', 0, 'Red', 'Dev1/port0/line3')
