    ...
    class LED : IDaqDigitalOutput
    {
        ...
        private async Task<bool> CheckThreshold()
        {
            Dictionary<string, string> parameters = new Dictionary<string, string>()
            {
                ...
                { "ColumnName", "LED_ID" },
                { "SearchData", ledIdentifier.ToString() }
            };
        ...
        private async void LEDLightningState(Object source, ElapsedEventArgs e)
        {
            ...
            else
            {
                ...
                UpdateStoredLEDState(stateOfLED);
            }
        ...
        public void SetOutputPortState()
        {
            try
            {
                ...
                digitalOutTask.DOChannels.CreateChannel(ChannelIdentifier, "LED" + ledIdentifier + "Channel", ChannelLineGrouping.OneChannelForEachLine);
        ...
        public void UpdateStoredLEDState(bool newLEDState)
        {
            foreach (Dictionary<string, string> el in GetStoredLEDInformation())
            {
                if (int.Parse(el["LED_ID"]) == ledIdentifier)
                {
