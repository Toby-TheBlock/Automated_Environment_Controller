-- ADDING A PROCEDURE
CREATE PROCEDURE UpdateEntry7Columns
...
@ColumnName5 char(30), @Value5 char(30), @ColumnName6 char(30), @Value6 char(30), @ColumnName7 char(30), @Value7 char(30), @ColumnName char(30), @SearchData char(30) AS 
...
+ QUOTENAME(@ColumnName6) + ' = ''' + @Value6 + ''', ' + QUOTENAME(@ColumnName7) + ' = ''' + @Value7 + ''' WHERE ' + QUOTENAME(@ColumnName) + ' = ''' + @SearchData + '''';
