...
INSERT ROLE (RoleID, RoleName, Description, AccessLevel) VALUES (0, 'User', 'Normal user which can access the data monitoring.', 1)
INSERT ROLE (RoleID, RoleName, Description, AccessLevel) VALUES (1, 'Admin', 'Elevated user who can access the data monitoring and change the sensor configuration values.', 2)
INSERT ROLE (RoleID, RoleName, Description, AccessLevel) VALUES (2, 'SuperAdmin', 'Top level user who can access and change everything.', 3)

INSERT USER (Username, Password, RoleID) VALUES ('Tobias', 'slippmeginn123', 2)
INSERT USER (Username, Password, RoleID) VALUES ('Testbruker', 'slippmeginn123', 1)
...
INSERT DAQ_CHANNEL (ChanIdentifier, InputChannel) VALUES ('Dev1/ai4', 1)
...
INSERT SENSOR (SensorID, Modell, SensorType, Producer, VoltageRating, MeasureFrequency, ChanIdentifier) VALUES (0, '165 - TMP36', 'Temperature', 'Adafruit', 5.0, '00.05.00.00', 'Dev1/ai1')
INSERT SENSOR (SensorID, Modell, SensorType, Producer, VoltageRating, MeasureFrequency, ChanIdentifier) VALUES (1, 'NTCLE100E3103JB0', 'Temperature', 'Vishay', 5.0, '00.05.00.00', 'Dev1/ai0')
INSERT SENSOR (SensorID, Modell, SensorType, Producer, VoltageRating, MeasureFrequency, ChanIdentifier) VALUES (2, 'ALS-PT333-3C/L177', 'Light level', 'Everlight Electronics', 5.0, '00.01.00.00', 'Dev1/ai2')

INSERT THRESHOLD_VALUE (Threshold, SensorID, MaxThreshold, MinThreshold) VALUES (1.0, 0, 0, 1)
INSERT THRESHOLD_VALUE (Threshold, SensorID, MaxThreshold, MinThreshold) VALUES (4.0, 0, 1, 0)
INSERT THRESHOLD_VALUE (Threshold, SensorID, MaxThreshold, MinThreshold) VALUES (1.0, 2, 0, 1)
INSERT THRESHOLD_VALUE (Threshold, SensorID, MaxThreshold, MinThreshold) VALUES (3.0, 2, 0, 0)
INSERT THRESHOLD_VALUE (Threshold, SensorID, MaxThreshold, MinThreshold) VALUES (5.0, 2, 1, 0)
